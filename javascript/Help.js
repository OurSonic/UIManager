...
(function() {
    ...
    window.Instantiate.create = function(proto) {
        var k = function(magic) { // call construct only if there's no magic cookie
            
            
            if (magic != isFn && isFn(this.start))
 ...
 for (key in proto)
     (function(fn, sfn,_key) { // create a closure
         k.prototype[_key] = !isFn(fn) || !isFn(sfn) ? fn : // add _super method
             function() {
                 var jf = sfn.apply(this, arguments);
                 if(jf) return jf;
                 return fn.apply(this, arguments);
             };
     })(proto[key], k.prototype[key],key);
